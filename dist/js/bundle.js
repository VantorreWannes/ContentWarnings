...
/* harmony export */   JsonContentCategory: () => (/* binding */ JsonContentCategory),
/* harmony export */   JsonFlagPrhase: () => (/* binding */ JsonFlagPrhase)
/* harmony export */ });
class Json {
    static toJson(data) {
...
/* harmony import */ var _json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./json */ "./src/Entities/json.ts");
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Entities_stored_item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Entities/stored_item */ "./src/Entities/stored_item.ts");
...
async function main() {
    const phrases_file_path = webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default().runtime.getURL("dist/data/flag_phrases.json");
    const categories = webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default().runtime.getURL("dist/data/content_categories.json");
    const phrases_stored = new _Entities_stored_item__WEBPACK_IMPORTED_MODULE_0__.LocallyStoredItem("flag-phrases", phrases_file_path);
    const categories_stored = new _Entities_stored_item__WEBPACK_IMPORTED_MODULE_0__.LocallyStoredItem("content-categories", categories);
    await printStoredItem(phrases_stored);
    await printStoredItem(categories_stored);
}
async function printStoredItem(stored) {
