...
var LocallyStoredItem = /** @class */ (function () {
    function LocallyStoredItem(name, path) {
        this.name = name;
        this.path = path;
    }
    LocallyStoredItem.prototype.download = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            throw new Error("Download HTTP error! status: ".concat(response.status));
                        }
    ...
    LocallyStoredItem.prototype.set = function (data) {
        var json = JSON.stringify(data);
        localStorage.setItem(this.name, json);
    };
    LocallyStoredItem.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            var json, data, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    LocallyStoredItem.prototype.update = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _stored_item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./stored_item */ "./src/stored_item.ts");
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var phrases_file_path, categories, phrases_stored, categories_stored;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    phrases_file_path = webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default().runtime.getURL("dist/data/flag_phrases.json");
                    categories = webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default().runtime.getURL("dist/data/content_categories.json");
                    phrases_stored = new _stored_item__WEBPACK_IMPORTED_MODULE_0__.LocallyStoredItem("flag-phrases", phrases_file_path);
                    categories_stored = new _stored_item__WEBPACK_IMPORTED_MODULE_0__.LocallyStoredItem("content-categories", categories);
                    return [4 /*yield*/, printStoredItem(phrases_stored)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, printStoredItem(categories_stored)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function printStoredItem(stored) {
    return __awaiter(this, void 0, void 0, function () {
        var phrases;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, stored.get()];
                case 1:
                    phrases = _a.sent();
                    console.log(phrases);
                    return [2 /*return*/];
